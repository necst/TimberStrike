...
from .dataset import divide_dataset_between_clients, load_single_dataset, load_partitions
from .server import FlServer, serverside_eval
from .utils import (
...
def main(cfg: DictConfig) -> None:
    ...
    if cfg.centralized:
        ...
        if not cfg.dataset.already_partitioned:
            ...
            trainloaders, valloaders, testloader = load_partitions(cfg.dataset.dataset_name,
                                                                   pool_size=cfg.clients.client_num,
                                                                   batch_size=cfg.batch_size,
        ...
        print(
            f"Best {cfg.dataset.task.metric.name}:",
...
def delete_saved_models():
    """Delete saved models from previous runs."""
    pass
