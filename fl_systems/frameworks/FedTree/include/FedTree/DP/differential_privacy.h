...
public:
     ...
     * @param value - gradient data
     */
    void add_noise_clip_gradient(float_type &value);

    /**
     * add noise to gradient data
     * @param value - gradient data
     * @param min_gradient - minimum gradient value
     * @param max_gradient - maximum gradient value
     */
    void add_noise_gradient(float_type &value, float_type min_gradient, float_type max_gradient) const;
};
